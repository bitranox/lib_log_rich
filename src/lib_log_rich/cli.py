...
``lib_log_rich.lib_log_rich`` the transport stays aligned
...
targets register the console script defined in :mod:`lib_log_rich.__init__conf__`.
...
from .lib_log_rich import hello_world as _hello_world
from .lib_log_rich import i_should_fail as _fail
from .lib_log_rich import main as _domain_main
...
def cli_main() -> None:
    ...
    What
        Delegates to :func:`lib_log_rich.lib_log_rich.main`
...
def cli_info() -> None:
    ...
    What
        Delegates to :func:`lib_log_rich.__init__conf__.print_info`
...
def cli_hello() -> None:
    ...
    What
        Calls :func:`lib_log_rich.lib_log_rich.hello_world`.
...
def cli_fail() -> None:
    ...
    What
        Calls :func:`lib_log_rich.lib_log_rich.i_should_fail`
