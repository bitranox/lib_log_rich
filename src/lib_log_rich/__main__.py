...
Purpose
-------
Provide the ``python -m lib_log_rich`` path mandated by the
...
consistent with calling :func:`lib_log_rich.cli.main` directly.
...
def _module_main() -> int:
    ...
    What
        Calls :func:`lib_log_rich.cli.main` while temporarily
    ...
    >>> with patch("lib_log_rich.cli.main", return_value=0):
    ...     _module_main()
    0
    """
